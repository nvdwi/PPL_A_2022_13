    ...
    <div class="card-body">
        ...
        <table class="table table-striped">
            ...
            <?php
                ...
                $query = "SELECT mahasiswa.nama, pkl.nim, mahasiswa.angkatan, pkl.nilai FROM pkl JOIN mahasiswa ON mahasiswa.nim = pkl.nim WHERE status_pkl='BELUM AMBIL' ORDER BY nim";
